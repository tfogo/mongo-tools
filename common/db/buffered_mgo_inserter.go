...
// BufferedMgoInserter implements a bufio.Writer-like design for queuing up
...
type BufferedMgoInserter struct {
	bulk            *mgo.Bulk
...
// NewBufferedMgoInserter returns an initialized BufferedMgoInserter
// for writing.
func NewBufferedMgoInserter(collection *mgo.Collection, docLimit int,
	continueOnError bool) *BufferedMgoInserter {
	bb := &BufferedMgoInserter{
...
func (bb *BufferedMgoInserter) Unordered() {
	bb.unordered = true
	bb.bulk.Unordered()
}

// throw away the old bulk and init a new one
func (bb *BufferedMgoInserter) resetBulk() {
...
func (bb *BufferedMgoInserter) Insert(doc interface{}) error {
...
func (bb *BufferedMgoInserter) Flush() error {
	if bb.docCount == 0 {
		return nil
	}
	defer bb.resetBulk()
